    ...
    "Statement": [
        {
            ...
            "Resource": [
              var.dynamodb_table_arn_dev,
              var.dynamodb_table_arn_prod
              ]
        },
        {
            "Sid": "VisualEditor1",
    ...
    Statement = [
      {
        ...
        Resource = [
          var.yolov5_sqs_queue_arn_dev,
          var.filters_sqs_queue_arn_dev,
          var.yolov5_sqs_queue_arn_prod,
          var.filters_sqs_queue_arn_prod
        ]
      }
    ]
  })
