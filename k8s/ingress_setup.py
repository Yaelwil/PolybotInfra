...
secret_name_to_set_dev = os.environ["SECRET_NAME_DEV"]

cert_prefix_prod = os.environ["CERT_PREFIX_PROD"]
key_prefix_prod = os.environ["KEY_PREFIX_PROD"]
secret_name_to_set_prod = os.environ["SECRET_NAME_PROD"]
...
if __name__ == "__main__":
    ...
    if PRIVATE_KEY_DEV and CERTIFICATE_DEV:
        create_tls_secret(secret_name_to_set_dev, PRIVATE_KEY_DEV, CERTIFICATE_DEV, "dev")

    if PRIVATE_KEY_PROD and CERTIFICATE_PROD:
        create_tls_secret(secret_name_to_set_prod, PRIVATE_KEY_PROD, CERTIFICATE_PROD, "prod")